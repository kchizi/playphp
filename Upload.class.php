...
//        'rootPath'      =>  '/opt/data/www/mis.bei.gameloft.org/documents/static/upload/upload_files/', //保存根路径
        'rootPath'      =>  'D:/wamp/www/new_mis/mis.bei.gameloft.org/static/upload/upload_files/',
        'savePath'      =>  '', //保存路径
        'saveName'      =>  'uniqueName', //上传文件命名规则，[0]-函数名，[1]-参数，多个参数使用数组
    ...
    public function upload($files='') {
        ...
        foreach ($files as $key => $file) {
            ...
            if ($this->save($file,$this->replace)) {
                ...
                $info[$key] = $file;
                $info[$key]['rootpath']=$this->rootPath;
            } else {
                $this->error = $this->getError();
            }
        }
